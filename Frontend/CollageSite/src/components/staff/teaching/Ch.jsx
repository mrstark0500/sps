...
const Ch = () => {
  ...
  const fetchStaff = async () => {
    try {
      ...
      // filter Chemical department only
      const filtered = staffArray.filter(
        (item) => item.department === "Chemical"
      );

      // reverse data so older staff comes first
      setStaff(filtered.reverse());

      console.log("Fetched Chemical staff:", filtered);
    } catch (err) {
  ...
  const handleAddStaff = async () => {
    ...
    try {
      ...
      // Add new staff to the **end** of the list
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 mt-2">
            Experienced faculty nurturing future chemical engineers
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {staff.map((member) => (
            ...
            >
              ...
              {/* Circular Image */}
              <div className="w-28 h-28 rounded-full border-4 border-green-100 overflow-hidden flex items-center justify-center mx-auto">
                <img
          ...
          {isAdmin && (
            <div
              ...
              className="cursor-pointer bg-white border-2 border-dashed border-green-300 rounded-xl flex items-center justify-center hover:bg-green-50 transition"
            >
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex flex-col items-center mb-4">
                <label className="cursor-pointer">
                  ...
                  />
                  <div className="w-24 h-24 rounded-full border-2 border-dashed border-green-400 flex items-center justify-center overflow-hidden hover:bg-green-50">
                    {newStaff.preview ? (
                      <img
