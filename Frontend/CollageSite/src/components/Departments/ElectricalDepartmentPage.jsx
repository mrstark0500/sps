...
import ElectricalStaff from "./../staff/teaching/Ee"; 

function ElectricalDepartmentInfo() {
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-10">
      ...
      <p className="text-lg text-gray-700 leading-relaxed">
        The Department of Electrical Engineering focuses on power systems,
        electrical machines, renewable energy, and modern electrical
        technologies to develop industry-ready engineers.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
        <div className="border rounded-lg p-6">
          ...
          <p className="text-gray-600">
            To create skilled electrical engineers with strong technical
        ...
        <div className="border rounded-lg p-6">
          ...
          <p className="text-gray-600">
            Deliver quality education in electrical engineering aligned with
            industry needs and sustainable development.
          </p>
        </div>
      </div>
    </div>
...
const ElectricalDepartmentPage = () => {
...
export default ElectricalDepartmentPage;
