...
const Co = () => {
  ...
  const fetchStaff = async () => {
    try {
      ...
      // filter Computer department only
      const filtered = staffArray.filter(
        (item) => item.department === "Computer"
      );

      // reverse so older staff appear first
      setStaff(filtered.reverse());

      console.log("Fetched Computer staff:", filtered);
    } catch (err) {
  ...
  const handleAddStaff = async () => {
    ...
    try {
      ...
      // append new staff to the end of the list
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 mt-2">
            Dedicated faculty shaping future technologists
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {isAdmin && (
            <div
              ...
              className="cursor-pointer bg-white border-2 border-dashed border-indigo-300 rounded-xl flex items-center justify-center hover:bg-indigo-50 transition"
            >
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex flex-col items-center mb-4">
                <label className="cursor-pointer">
                  ...
                  />
                  <div className="w-24 h-24 rounded-full border-2 border-dashed border-indigo-400 flex items-center justify-center overflow-hidden hover:bg-indigo-50">
                    {newStaff.preview ? (
                      <img
