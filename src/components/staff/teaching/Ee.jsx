  ...
  const fetchStaff = async () => {
    try {
      ...
      const filtered = staffArray.filter(
        (item) => item.department === "Electrical"
      );

      // reverse so older staff appear first
      setStaff(filtered.reverse());

      console.log("Fetched Electrical staff:", filtered);
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 mt-2">
            Empowering students with electrical innovation and excellence
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="flex justify-center">
                <img
                  ...
                  alt={member.name}
                  className="w-28 h-28 rounded-full object-cover border-4 border-yellow-100"
                />
              </div>
          ...
          {isAdmin && (
            <div
              ...
              className="cursor-pointer bg-white border-2 border-dashed border-yellow-300 rounded-xl flex items-center justify-center hover:bg-yellow-50 transition"
            >
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex flex-col items-center mb-4">
                <label className="cursor-pointer">
                  ...
                  />
                  <div className="w-24 h-24 rounded-full border-2 border-dashed border-yellow-400 flex items-center justify-center overflow-hidden hover:bg-yellow-50">
                    {newStaff.preview ? (
                      <img
