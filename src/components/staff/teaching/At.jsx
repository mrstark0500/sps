...
const At = () => {
  ...
  const fetchStaff = async () => {
    try {
      ...
      const filtered = staffArray
        .filter((item) => item.department === "Automobile")
        .reverse(); // Reverse order so older staff first

      setStaff(filtered);
      console.log("Fetched Automobile staff:", filtered);
    } catch (err) {
  ...
  const handleAddStaff = async () => {
    ...
    try {
      ...
      setStaff((prev) => [...prev, res.data.staff || res.data]);
    ...
    <section className="bg-gray-50 py-14 mt-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-gray-900">Automobile Department</h2>
          <p className="text-gray-600 mt-2">
            Skilled professionals driving automotive excellence
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {staff.map((member) => (
            ...
            >
              ...
              <p className="text-sm text-orange-600 font-medium mt-1">{member.role}</p>
          ...
          {isAdmin && (
            <div
              ...
              className="cursor-pointer bg-white border-2 border-dashed border-orange-300 rounded-xl flex items-center justify-center hover:bg-orange-50 transition"
            >
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex flex-col items-center mb-4">
                <label className="cursor-pointer">
                  ...
                  />
                  <div className="w-24 h-24 rounded-full border-2 border-dashed border-orange-400 flex items-center justify-center overflow-hidden hover:bg-orange-50">
                    {newStaff.preview ? (
                      <img
